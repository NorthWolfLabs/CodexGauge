...
- Added native menu-bar allowance monitoring for Apple Silicon Macs running macOS 14 or later.
...
- Disabled Writing Tools for telemetry, path, and numeric surfaces so short-lived popovers do not retain unnecessary Apple Intelligence sessions, and expanded performance samples with resident and maximum-footprint diagnostics.
